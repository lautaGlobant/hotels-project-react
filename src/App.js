...
class App extends React.Component {
    ...
    hotelsData : [
      {
        ...
        availabilityFrom: new Date().valueOf(),
        availabilityTo: new Date().valueOf() + 864000000, // 10 days
        rooms: 11,
        city: 'Buenos Aires',
        country: 'Argentina',
        price: 4
      },
      {
        ...
        availabilityFrom: new Date().valueOf() + 864000000, // 10 days
        availabilityTo: new Date().valueOf() + 1296000000, // 15 days
        rooms: 23,
        city: 'Mar del Plata',
        country: 'Argentina',
        price: 2
      },
      {
        ...
        availabilityFrom: new Date().valueOf() + 432000000, // 5 days
        availabilityTo: new Date().valueOf() + 1296000000, // 15 days
        rooms: 16,
        city: 'Mendoza',
        country: 'Argentina',
      ...
      },
      {
        ...
        availabilityFrom: new Date().valueOf() + 1728000000, // 20 days
        availabilityTo: new Date().valueOf() + 2592000000, // 30 days
        rooms: 32,
        city: 'Jujuy',
        country: 'Argentina',
        price: 1
      },
      {
        ...
        availabilityFrom: new Date().valueOf(),
        availabilityTo: new Date().valueOf() + 432000000, // 5 days
        rooms: 14,
        city: 'Salta',
        country: 'Argentina',
        price: 2
      },
      {
        ...
        availabilityFrom: new Date().valueOf() + 1296000000, // 15 days 
        availabilityTo: new Date().valueOf() + 2592000000, // 30 days
        rooms: 16,
        city: 'Córdoba',
        country: 'Argentina',
      ...
      },
      {
        ...
        availabilityFrom: new Date().valueOf() + 2592000000, // 30 days
        availabilityTo: new Date().valueOf() + 3456000000, // 40 days
        rooms: 40,
      ...
      },
      {
        ...
        availabilityFrom: new Date().valueOf() + 864000000, // 10 days
        availabilityTo: new Date().valueOf() + 1728000000, // 20 days
        rooms: 21,
        city: 'Pucón',
        country: 'Chile',
        price: 4
      ...
      },
      {
        ...
        availabilityFrom: new Date().valueOf() + 2160000000, // 25 days
        availabilityTo: new Date().valueOf() + 2592000000, // 30 days
        rooms: 4,
        city: 'Colonia',
        country: 'Uruguay',
  ...
  render() {
    return (
      <div className="App">
        <Header handleEnterDate={(filter) => { this.setState(prev => ({ filters : {...prev.filters, dateFrom:filter} })) }} handleExitDate={(filter) => { this.setState(prev => ({ filters : {...prev.filters, dateTo:filter} })) }} handlePrice={(filter) => { this.setState(prev => ({ filters : {...prev.filters, price:filter} })) }} handleRooms={(filter) => { this.setState(prev => ({ filters : {...prev.filters, rooms:filter} })) }} handleCountry={(filter) => { this.setState(prev => ({ filters : {...prev.filters, country:filter} })) }}/>
        <Content hotels={this.state.hotelsData} filter={this.state.filters} />
      </div>
    );
  }
}
